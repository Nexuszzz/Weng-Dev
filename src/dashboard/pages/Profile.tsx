          ...
          <div className="md:col-span-2 bg-white dark:bg-surface-dark p-6 rounded-xl border border-gray-200 dark:border-gray-700 space-y-6">
            ...
            <div>
              <h2 className="text-lg font-semibold mb-3 flex items-center justify-between">Portofolio Singkat
                <a href="/dashboard/portfolio" className="text-xs font-medium text-purple-600 hover:underline">Lihat Semua</a>
              </h2>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {topProjects.map(p => (
                  <div key={p.id} className="p-4 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/40">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {p.tech.slice(0,3).map(t => <span key={t} className="text-[10px] bg-white/70 dark:bg-gray-900/40 px-2 py-0.5 rounded border border-gray-200 dark:border-gray-600">{t}</span>)}
                    </div>
                  </div>
                ))}
              </div>
