...
const MOCK_TALENT_CANDIDATES: any[] = [
  {
    id: 'cand-1',
    name: 'Budi Santoso',
  ...
  },
  {
    ...
    availability: 'available',
    salaryExpectation: { min: 13000000, max: 17000000, currency: 'IDR' },
  ...
  },
  {
    ...
    availability: 'busy',
    salaryExpectation: { min: 18000000, max: 23000000, currency: 'IDR' },
  ...
  },
  {
    ...
    salaryExpectation: { min: 23000000, max: 28000000, currency: 'IDR' },
  ...
  },
  {
    ...
    availability: 'available',
    salaryExpectation: { min: 22000000, max: 27000000, currency: 'IDR' },
...
const TalentSearch: React.FC = () => {
  ...
  const getAvailabilityLabel = (availability?: string) => {
    switch (availability) {
      ...
      case 'not_available': return 'Tidak Tersedia';
            ...
            <CardContent className="p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 font-medium">{candidate.title || 'Tidak ada posisi'}</p>
                ...
                <div className="text-sm">
                  ...
                  <p className="font-medium">
                    {candidate.salaryExpectation 
                      ? `Rp ${candidate.salaryExpectation.min.toLocaleString('id-ID')} - ${candidate.salaryExpectation.max.toLocaleString('id-ID')}`
                      : 'Tidak disebutkan'
                    }
                  </p>
                </div>
