...
const OAuthCallback: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-emerald-900 text-white flex items-center justify-center p-6">
        ...
        <div className="bg-gray-900/70 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/10 p-8">
          ...
          {status === 'error' ? (
            <div className="flex flex-col items-center gap-2">
              ...
              <Link to="/login" className="mt-2 text-emerald-400 hover:text-emerald-300">Kembali ke Login</Link>
            </div>
          ) : null}
        </div>
      </motion.div>
